...
{
    public class TrainingServicesHc : IHealthCheck
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpCheck _httpCheck;
        public TrainingServicesHc(IHttpCheck httpCheck)
        {
        ...
        public async Task<HealthCheckResult> CheckHealthAsync(
            ...
            => await _httpCheck.CheckHealthAsync(_configuration["api:training"] + "values/");
    }
}
