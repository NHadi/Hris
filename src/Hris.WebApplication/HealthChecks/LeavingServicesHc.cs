...
{
    public class LeavingServicesHc : IHealthCheck
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpCheck _httpCheck;
        public LeavingServicesHc(IHttpCheck httpCheck)
        {
        ...
        public async Task<HealthCheckResult> CheckHealthAsync(
            ...
            => await _httpCheck.CheckHealthAsync(_configuration["api:leaving"] + "values/");
    }
}
