...
{
    public class TravellingServicesHc : IHealthCheck
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpCheck _httpCheck;
        public TravellingServicesHc(IHttpCheck httpCheck)
        {
        ...
        public async Task<HealthCheckResult> CheckHealthAsync(
            ...
            => await _httpCheck.CheckHealthAsync(_configuration["api:travelling"] + "values/");
    }
}
