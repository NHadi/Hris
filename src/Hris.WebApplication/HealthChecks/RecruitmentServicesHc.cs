...
{
    public class RecruitmentServicesHc : IHealthCheck
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpCheck _httpCheck;
        public RecruitmentServicesHc(IHttpCheck httpCheck)
        {
        ...
        public async Task<HealthCheckResult> CheckHealthAsync(
            ...
            => await _httpCheck.CheckHealthAsync(_configuration["api:recruitment"] + "values/");
    }
}
