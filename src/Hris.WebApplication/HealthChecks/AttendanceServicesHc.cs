...
{
    public class AttendanceServicesHc : IHealthCheck
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpCheck _httpCheck;
        public AttendanceServicesHc(IHttpCheck httpCheck)
        {
        ...
        public async Task<HealthCheckResult> CheckHealthAsync(
            ...
            => await _httpCheck.CheckHealthAsync(_configuration["api:attendance"] + "values/");
    }
}
